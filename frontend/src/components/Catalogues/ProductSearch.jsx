...
import banner from "../../assets/Gemini_Generated_Image_5le7ip5le7ip5le7.png";
...
const ProductSearch = () => {
  ...
  return (
    <div className='lux-shell flex justify-center items-center'>
      <div className="product-search-container ">
        ...
        {currentSection === 'image' && (
          <div className="flex flex-col justify-center items-center mx-5 border-2 border-gray-600 p-4 rounded">
            ...
            />
            {image && (
              <Button variant="contained" color="green" className="mt-4 w-[80%] !bg-[#ff5a1f] hover:!bg-[#ff7a2a] !text-black font-bold" onClick={handleImageUpload}>
                Upload and Search
              </Button>
            )}
          </div>
        ...
        {currentSection === 'search' && (
          <div className="flex gap-10 justify-center items-center mx-5 border-2 border-gray-600 p-4 rounded flex-col">
            ...
            <div className="flex gap-5">
              <Button variant="filled" color="amber" className="flex items-center gap-3 max-w-56 !bg-[#ff5a1f] hover:!bg-[#ff7a2a] !text-black font-bold" id="voiceButton" onClick={handleVoiceInput}>
              ...
              <Button variant="contained" color="green" className="mt-4 w-[80%] !bg-[#ff5a1f] hover:!bg-[#ff7a2a] !text-black font-bold" onClick={handleSearch}>
                Search
              </Button>
            </div>
          </div>
        ...
        <div className="flex justify-center items-center flex-wrap gap-5 mx-5">
          <Link className='text-[#ff5a1f] text-lg underline' to="/add-catalog" >
            I am adding a product not available in CatalogCraft
          </Link>
          <Link className='text-[#ff5a1f] text-lg underline' to="/bulk-data" >
